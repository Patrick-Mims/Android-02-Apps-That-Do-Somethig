...
public class DrinkModel {
    ...
    public String StrInstructionsZHANS;
    public String StrInstructionsZHANT;
    ...
    public DrinkModel(String idDrink,
                      String strDrink,
                      ...
                      String strInstructionsZHANS,
                      String strInstructionsZHANT,
        ...
        StrInstructionsZHANS = strInstructionsZHANS;
        StrInstructionsZHANT = strInstructionsZHANT;
    ...
    public String getStrInstructionsZHANS() {
        return StrInstructionsZHANS;
    }

    public String getStrInstructionsZHANT() {
        return StrInstructionsZHANT;
    }
